...
urlpatterns = [
    ...
    path('company/employee', views.EmployeeList.as_view(), name='employee_list'),
    ...
    path('company/devices-logs', views.DeviceLogList.as_view(), name='device_log_list'),
    path('company/devices-logs/<int:pk>', views.DeviceLogDetail.as_view(), name='device_log_detail'),
]